        ...
        for (int i=1 ; i<34; i++)
        {
            for(int j=1;j<44; j++)
            {
                if(matricelibre[i][j]==0 &&
                   ((map[i+1][j]==1 || map[i-1][j]==1 || map[i][j+1]==1 || map[i][j-1]==1) || (map[i+1][j]==2 || map[i-1][j]==2 || map[i][j+1]==2 || map[i][j-1]==2) ))
                {
                ...
                if(matricelibre[i][j]==0 && matricelibre[i][j+1]==0 && matricelibre[i][j+2]==0 && matricelibre[i][j+3]==0 &&
                   ...
                   (( map[i+1][j]==1 || map[i+1][j+1]==1 || map[i+1][j+2]==1 || map[i+1][j+3]==1 ||
                    ...
                    (map[i+1][j-1]==2 || map[i+1][j]==2 || map[i+1][j+1]==2 || map[i+1][j+2]==2 || map[i+1][j+3]==2 ||
                     ...
                     map[i-6][j-1]==2 || map[i-5][j-1]==2 || map[i-4][j-1]==2 || map[i-3][j-1]==2 || map[i-2][j-1]==2 || map[i-1][j-1]==2 || map[i][j-1]==2)))
                {
                    masked_stretch_blit(tuile_surbrillance, page, 0, 0, 20, 20, j * 20, i * 20, 20, 20);
                }
            }
