    ...
    while(clic!=1)
    {
        ...
        if((testclic==1 && *banque>1000
           ...
           && ((map[y+1][x-1]==1 || map[y+1][x]==1 || map[y+1][x+1]==1 || map[y+1][x+2]==1 ||
               ...
               ||  ( map[y+1][x-1]==2 || map[y+1][x]==2 || map[y+1][x+1]==2 || map[y+1][x+2]==2 ||
                     map[y+1][x+3]==2 || map[y][x+3]==2 || map[y-1][x+3]==2 || map[y-2][x+3]==2 ||
                     map[y-3][x+3]==2 || map[y-3][x+2]==2 || map[y-3][x+1]==2 || map[y-3][x]==2 ||
    ...
    while(clic!=1)
    {
        ...
        if((testclic==1 && *banque>=100000 &&
           ...
           ((map[y+1][x-1]==1 || map[y+1][x]==1 || map[y+1][x+1]==1 || map[y+1][x+2]==1 || map[y+1][x+3]==1 ||
            ...
            (map[y+1][x-1]==2 || map[y+1][x]==2 || map[y+1][x+1]==2 || map[y+1][x+2]==2 || map[y+1][x+3]==2 ||
             map[y+1][x+4]==2 || map[y][x+4]==2 || map[y-1][x+4]==2 || map[y-2][x+4]==2 || map[y-3][x+4]==2 || map[y-4][x+4]==2 || map[y-5][x+4]==2 ||
             map[y-6][x+4]==2 || map[y-6][x+3]==2|| map[y-6][x+2]==2 || map[y-6][x+1]==2 || map[y-6][x]==2 ||
             map[y-6][x-1]==2 || map[y-5][x-1]==2 || map[y-4][x-1]==2 || map[y-3][x-1]==2 || map[y-2][x-1]==2 || map[y-1][x-1]==2 || map[y][x-1]==2)
           ))
        {
            map[y][x] = 16;
            map[y-1][x] =16;
